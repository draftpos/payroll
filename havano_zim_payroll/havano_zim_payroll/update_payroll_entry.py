...
def run():
    ...
    fields = [
        {
            "fieldname": "total_taxable_income_usd",
            "fieldtype": "Float",
            "label": "Total Taxable Income USD",
            "in_list_view": 1,
            "insert_after": "employee_deductions"
        },
        {
            "fieldname": "total_taxable_income_zwg",
            "fieldtype": "Float",
            "label": "Total Taxable Income ZWG",
            "in_list_view": 1,
            "insert_after": "total_taxable_income_usd"
        }
    ]
